...
<div id="content-wrapper">
    ...
    <form action="<?php echo site_url('album/editer/'.$album->id); ?>" method="post" class="panel form-horizontal" enctype="multipart/form-data">
        <div class="panel-heading">
            <span class="panel-title">Edition de photo</span><span class="pull-right text-sm text-danger"><sup>*</sup>champs obligatoires</span>
        </div>
        <div class="panel-body">
            <div class="row form-group">
                <label class="col-sm-4 col-md-2 control-label">Titre<sup class="text-danger">*</sup></label>
                <div class="col-sm-8 col-md-10">
                    <input type="text" name="title" class="form-control" placeholder="Titre de l'image" required value="<?php echo $album->title; ?>">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-8 col-md-10">
                    <textarea rows="4" name="description" class="form-control expanding-input-target" placeholder="Description de l'image"><?php echo $album->description; ?></textarea>
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <img class="col-md-3 thumbnail" src="<?php echo $album->photo; ?>" />
                    <?php
                    if (isset($error)) {
                        echo $error;
                    }
