...
<div id="content-wrapper">
    ...
    <form action="<?php echo site_url('categorie/creer'); ?>" method="post" class="panel form-horizontal" enctype="multipart/form-data">
        <div class="panel-heading">
            <span class="panel-title">Création de catégorie</span><span class="pull-right text-sm text-danger"><sup>*</sup>champs obligatoires</span>
        </div>
        <div class="panel-body">
            <div class="row form-group">
                <label class="col-sm-4 col-md-2 control-label">Titre<sup class="text-danger">*</sup></label>
                <div class="col-sm-8 col-md-10">
                    <input type="text" name="title" class="form-control" placeholder="Titre de la catégorie" required value="<?php echo set_value('title'); ?>">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-8 col-md-10">
                    <textarea rows="4" name="description" class="form-control expanding-input-target" placeholder="Description de la catégorie"><?php echo set_value('description'); ?></textarea>
